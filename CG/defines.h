...
GLfloat l1ambient[] = {BRANCO, 1.0};
GLfloat l1diffuse[] = {BRANCO, 1.0};
GLfloat l1cor[] = {BRANCO, 1.0};
GLfloat l1position[] = {-5.0, 4.0, -5.0};

GLfloat materialColor[] = {0.50, 1.53, 1.21, 1.0};
GLfloat materialSpecular[] = {0.7, 0.7, 0.7, 1.0};
GLfloat materialEmission[] = {0.7, 0.7, 0.7, 1.0};
